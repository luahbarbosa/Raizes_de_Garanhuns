    ...
    <View style={styles.container}>
      <View style={styles.introduction}>
        <Text style={styles.title}>
          Garanhuns em cada esquina
        </Text>

        <Text style={styles.subtitle}>
          Um roteiro afetivo pelos pontos turísticos, culturais
          e naturais que fazem da cidade um destino único no Agreste.
        </Text>
      </View>
